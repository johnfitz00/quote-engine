...
data class Money(
    ...
    fun multiply(factor: BigDecimal): Money = copy(amount = amount.multiply(factor).setScale(2, RoundingMode.HALF_EVEN))
    ...
    companion object {
        fun of(
            amount: String,
            currency: String,
        ): Money = Money(BigDecimal(amount).setScale(2, RoundingMode.HALF_EVEN), currency)
    }
}
